...
export default function DictSelect({ category, stage, value, onChange, placeholder, style, mode, allowClear = true }) {
  ...
  return (
    <Select
      value={value} onChange={onChange} mode={mode} allowClear={allowClear}
      placeholder={placeholder || '请选择'} style={{ minWidth: 140, ...style }}
      showSearch optionFilterProp="label" options={options}
    />
  );
}
