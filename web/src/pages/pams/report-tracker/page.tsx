/**
 * @file page.tsx
 * @description PAMS 跟踪人专属视角的缺陷分配、跟进管理控制台
 * @author hengguan
 * @date 2026-05-20
 */
...
export default function ReportPage() {
    ...
    const handleUserSelect = (value: string, option: any) => {
        ...
        if (form.getFieldValue('selectingField') === 'reporter') {
            ...
            // Default to Tracker (old submitter)
            form.setFieldsValue({
                    ...
                    <Card size="small" style={{ marginBottom: 24, boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                        ...
                        >
                            ...
                            <Form.Item
                                ...
                                style={unmatchedFields.has('summary') ? { borderColor: '#1890ff' } : {}}
                            >
                            ...
                            <Form.Item
                                ...
                                style={unmatchedFields.has('details') ? { borderColor: '#1890ff' } : {}}
                            >
