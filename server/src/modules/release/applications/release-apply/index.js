/**
 * 文件：server/src/modules/release/applications/release-apply/index.js
...
export { claimReleaseApplyCode, generateReleaseApplyCode, previewReleaseApplyCode } from './application/numbering.js';
