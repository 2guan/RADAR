...
export const REQUIRED_FIELD_MODULES = [
  {
    ...
    fields: [
      ...
      { key: 'apply_release_points', label: '申请投产点', valueType: 'array' },
      { key: 'expected_release_date', label: '期望投产时间' },
      { key: 'propose_time', label: '提出时间' },
      { key: 'issue_no', label: 'OA编号/工单编号' },
      { key: 'is_accounting', label: '是否涉账' },
      { key: 'priority', label: '优先级' },
      { key: 'title', label: '需求标题' },
      { key: 'summary', label: '需求概述' },
      { key: 'implementation_org', label: '实施机构' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'release_point_id', label: '申请投产点' },
