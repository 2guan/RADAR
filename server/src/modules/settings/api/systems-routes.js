...
import { all, get, run, listQuery } from '../../../platform/persistence/index.js';
...
export default async function systemRoutes(fastify) {
  registerCrud(fastify, {
    ...
    writable: ['sys_code', 'sys_name', 'org', 'sector', 'out_dept', 'deploy_dept', 'sort'],
    fieldLabels: {
      sys_code: '系统编号', sys_name: '系统名称', org: '所属机构', sector: '所属板块',
      out_dept: '变更负责部门（输出口径）', deploy_dept: '变更负责部门（部署口径）', sort: '排序',
    },
    codeField: 'sys_code',
    skipList: true,
  ...
  registerIO(fastify, {
    ...
    columns: [
      ...
      { key: 'org', title: '所属机构' }, { key: 'sector', title: '所属板块' },
