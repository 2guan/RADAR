...
const APP_CONFIG = [
  ...
  ['code.dev', 'RW_{需求/工单编号}_{序号}', '开发任务编号规则'],
  ['code.test.SIT', 'SIT_{需求/工单编号}_{序号}', '应用组装测试任务编号规则'],
  ['code.test.UAT', 'UAT_{需求/工单编号}_{序号}', '用户测试任务编号规则'],
  ['code.test.NFT', 'NFT_{需求/工单编号}_{序号}', '非功能测试任务编号规则'],
  ['code.test.SEC', 'SEC_{需求/工单编号}_{序号}', '安全测试任务编号规则'],
