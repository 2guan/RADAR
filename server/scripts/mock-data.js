...
// ---------------------------------------------------------------------------
const ORG_ATTR_BY_LEGACY_DISPLAY = Object.freeze({
  交付: '交付事业部', 北京: '北京事业群', 农信: '云南农信', 成都: '成都事业群',
  上海: '上海事业群', 深圳: '深圳事业群', 厦门: '厦门事业群', 大数据: '大数据中心', 金科: '建信金科',
});
...
].map(([phone, name, org, roles]) => [phone, name, ORG_ATTR_BY_LEGACY_DISPLAY[org] || org, roles]);
