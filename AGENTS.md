...
1. 确认需求编号，读取 `docs/requirements/<REQ>/requirement.md` 与 `ai-task-scope.yaml`，并完成影响分析识别出的相关文档。需求、任务范围、相关文档或目标模块缺失时停止改动；不得先改代码再补文档。
...
| 分支、提交、PR | 当前分支是否与任务范围一致，名称是否满足 `<开发者账号>/REQ-YYYYMMDD-001-short-name` |
